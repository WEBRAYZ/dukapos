...
const ProvisionTenantModal: React.FC<ProvisionTenantModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center p-4 pt-12 md:pt-20 overflow-y-auto custom-scrollbar">
      ...
      {/* Modal Content */}
      <div className="bg-white w-full max-w-xl rounded-[2.5rem] shadow-2xl border border-blue-100 overflow-hidden relative z-10 animate-in fade-in slide-in-from-top-8 duration-500">
        <div className="bg-linear-to-l from-blue-800 to-blue-950 p-8 text-white relative overflow-hidden">
          <div className="relative z-10">
            <h3 className="text-2xl font-black uppercase tracking-tight">Provision New Tenant</h3>
            <p className="text-xs font-bold text-blue-200 uppercase mt-1">Onboard a new business to the ecosystem</p>
          </div>
        ...
        <div className="p-8 space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <label className="text-[10px] font-black text-blue-900 uppercase tracking-widest">Business Name</label>
              <input 
                type="text" 
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-black text-blue-900 uppercase tracking-widest">Owner Name</label>
              <input 
                type="text" 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <label className="text-[10px] font-black text-blue-900 uppercase tracking-widest">Email Address</label>
              <input 
                type="email" 
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-black text-blue-900 uppercase tracking-widest">Region</label>
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-black text-blue-900 uppercase tracking-widest">Subscription Tier</label>
            <div className="grid grid-cols-3 gap-3">
              {['Starter', 'Professional', 'Enterprise'].map((tier) => (
                <button 
                  key={tier}
                  className={`px-4 py-4 rounded-sm border text-[10px] font-black uppercase transition-all ${
                    tier === 'Professional' ? 'bg-blue-900 text-white border-blue-900 shadow-lg' : 'bg-slate-50 text-gray-400 border-blue-50 hover:border-blue-200'
                  }`}
                >
                  {tier}
                </button>
